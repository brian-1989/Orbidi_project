from app.models.location_category_reviewed import (
    LocationCategoryReviewed as ReviewedModel
)
...
def create_location_category_reviewed_in_db(
        reviewed_schema: ReviewedSchema, db: Session):
    try:
        db_reviewed = ReviewedModel(
            location_id=reviewed_schema.location_id,
            category_id=reviewed_schema.category_id,
